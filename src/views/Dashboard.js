...
function Dashboard(props) {
  ...
  orders.map(o=>{
    ...
    const data = {
      labels: [
      "prete",  "en attente", "en traitement","complete"
      ],
      datasets: [
        {
          data: [
        ...
        datasets: [
          {
            ...
            borderColor: 'rgba(0,0,0,1)',
            borderWidth: 2,
            data: [getdaytotal(6), getdaytotal(5), getdaytotal(4),getdaytotal(3),getdaytotal(2),getdaytotal(1),getdaytotal(0)]
          }
        ]
    ...
    const fetchingorders= () =>{
      if(props.company.data === undefined){
        axios.get(url+"/api/v2/order/"+parseInt(props.company["company"][6])
          ...
          axios.get(url+"/api/v2/order/"+parseInt(props.company.data.id)
          ).then(
              res=>{
                  console.log(res)
                  setOrders(res.data.order_list)
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div>
                      <p ><b>le totale des commande active d'aujourd'hui</b></p>
                      <Card.Title as="h4">{totalincome()} <small>DT</small></Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div>
                      <p ><b>le revenu totale des commande compeletés d'aujourd'hui</b></p>
                      <Card.Title as="h4">{totalgain()} <small>DT</small></Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div>
                      <p ><b>le revenu totale des commande compeletés ce mois</b></p>
                      <Card.Title as="h4">{getmonth()} <small>DT</small></Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
