        ...
        <GridItem>
          <Card>
            <CardHeader color="info" stats icon>
              <CardIcon color="info">
                <Icon>
                  <img src={p.image} alt="" width="100" height="120"></img>
                </Icon>
              </CardIcon>
        ...
        <span>
          <Link to="./Clients">
            <button className="product_add_btn">
              Clients dans {props.user.data.city}
            </button>
          </Link>
        </span>
        <span>
          <Link to="./Oldclients">
            <button className="product_add_btn"> tous les clients</button>
          </Link>
        </span>
      </div>
      <div>
        <h3>clients de la plateforme</h3>
      </div>
